...
export const TaskSchema = z.object({
  ...
  id: z.string().min(1),
  title: z.string().min(1),
  definition_of_done: z.array(z.string().min(1)).default([]),
  test_cases: z.array(z.string().min(1)).default([]),
  description: z.string().min(1),
  assigned_session: z.string().default(""),
  assigned_model: z.string().default(""),
