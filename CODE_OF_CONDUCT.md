...
community leaders responsible for enforcement via the contact listed on the
[bosun-sh](https://github.com/bosun-sh) GitHub profile or by opening a
[private security advisory](https://github.com/bosun-sh/logbook/security/advisories/new)
(GitHub security advisories support general contact, not only security issues).
